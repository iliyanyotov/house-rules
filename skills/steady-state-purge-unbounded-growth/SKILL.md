...
- Colm MacCárthaigh, [*Reliability, constant work, and a good cup of coffee*](https://builder.aws.com/content/3F05oqNtNUWxHJ5r6L6I2HrH4rI/reliability-constant-work-and-a-good-cup-of-coffee) (AWS Builders' Library) — the constant-work pattern: systems that do the same uniform work regardless of conditions. Adjacent to, not identical with, bounded footprint — but the same instinct: cost per unit time shouldn't scale with accumulated state.

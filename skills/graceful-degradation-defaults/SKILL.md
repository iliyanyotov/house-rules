...
- Jacob Gabrielson, ["Avoiding fallback in distributed systems"](https://builder.aws.com/content/3EuS9Sakq7L3VLQIF3qzfMfke1Y/avoiding-fallback-in-distributed-systems) (AWS Builders' Library) — the counterweight: rarely-exercised fallback code fails when first exercised; prefer continuously-run degraded paths over incident-only branches.
